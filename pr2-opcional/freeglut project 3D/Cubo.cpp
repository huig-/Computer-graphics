...
Cubo::Cubo(double l) {
	...
	// Vértices de abajo
	vertice[0]=new PuntoVector3D(l, -l, l, 1);
	vertice[1]=new PuntoVector3D(l, -l, -l, 1);
	vertice[2]=new PuntoVector3D(-l, -l, -l, 1);
	vertice[3]=new PuntoVector3D(-l, -l, l, 1);
	// Vértices de arriba
	vertice[4]=new PuntoVector3D(l, l, l, 1);
	vertice[5]=new PuntoVector3D(l, l, -l, 1);
	vertice[6]=new PuntoVector3D(-l, l, -l, 1);
	vertice[7]=new PuntoVector3D(-l, l, l, 1);
