...
void key(unsigned char key, int x, int y){
	...
	switch (key) {
		...
		case 'v': coche->gira(1.0f); break;
		case 'b': coche->gira(-1.0f); break;
		case 'u': ambiental = !ambiental; break;
		case 't': glEnable(GL_LIGHT1); break;
		case 'g': glDisable(GL_LIGHT1); break;
		case 'r': glEnable(GL_LIGHT2); farola->setEnable(true); break;
		case 'f':  glDisable(GL_LIGHT2); farola->setEnable(false); break;
		...
		case '2': cam->giraY(); break;
		case '3': cam->giraZ(); break;
		case '4': cam->lateral(); break;
		case '5': cam->frontal(); break;
		case '6': cam->cenital(); break;
